...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CounterStore = __webpack_require__(160);
	...
	var Counter = (function (_Component) {
		...
		function Counter() {
			...
			_this.state = _CounterStore2.default.getState();
			console.log('constructing, ', _this.state);
			return _this;
		}
		...
		_createClass(Counter, [{
			...
			value: function componentDidMount() {
				_CounterStore2.default.listen(this.handleClick);
			}
		}, {
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				_CounterStore2.default.unlisten(this.handleClick);
			}
		}, {
			key: 'handleClick',
			value: function handleClick(syntheticMouseClick) {
				// CounterStore.getCounter();
				_CounterActions2.default.incrementCounter(1).defer();
			}
		}, {
			key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CounterStore = (function () {
		function CounterStore() {
			...
			this.bindListeners({
				handleIncrementCounter: _CounterActions2.default.INCREMENT_COUNTER
			});
		}
		...
		_createClass(CounterStore, [{
			key: 'handleIncrementCounter',
			value: function handleIncrementCounter(num) {
	...
	module.exports = _alt2.default.createStore(CounterStore, 'CounterStore');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CounterActions = (function () {
		...
		_createClass(CounterActions, [{
			...
			value: function incrementCounter(num) {
				this.dispatch(num);
			}
		}]);
	...
	module.exports = _alt2.default.createActions(CounterActions);
